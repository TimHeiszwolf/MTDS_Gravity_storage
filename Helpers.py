...
def make_3Dfunction_plot(function, amount_of_days = 364, increments_in_day = 200, zlabel = "", title = "", view_position = [60, -120]):
    """
    ...
    wf.view_init(view_position[0], view_position[1])# Its reversed from matplotlib
